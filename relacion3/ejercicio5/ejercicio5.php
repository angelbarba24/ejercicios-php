        ...
        <div id="wrapper" class="d-flex justify-content-center align-items-center">
            <form class="shadow p-3 rounded w-50" id="formulario" action=<?php echo htmlspecialchars("calculo.php")?> method="get">
                ...
                <div>
                    ...
                    <div id="emailHelp" class="form-text text-danger">El correo electrónico no tiene el formato correcto.</div>
                </div>
                ...
                <div id="documentoHelp" class="form-text text-danger">El documento no tiene el formato correcto.</div>
